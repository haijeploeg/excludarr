...
class Movie(Manager):
    ...
    def add_movie(self, title, quality_profile_id, title_slug, images, tmdb_id, year, root_folder_path, path=None, monitored=True, search_for_movie=False):
        """
    ...
    def update_movie(self, updated_movie_dict, move_files=False):
        ...
        return self.client.http_put(self.movie_path, params=params, json=updated_movie_dict)
